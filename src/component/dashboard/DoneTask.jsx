...
function DoneTask({ task, opa, setOpa, setTask, bindTask, setBindTask }) {
  return (
        ...
        <div className="container" style={{ marginTop: "40px" }}>
          <div className="d-flex">
              ...
              <div className="pt-2 mb-4">
                <div className="d-flex">
                  <div className="myLink">
                    <i className="count"> {Utils.random(1, 82)} </i>
                  ...
                  <div className="myLink">
                    <i className="count"> {Utils.random(1, 70)} </i>
                    <Link>Note</Link>
                  </div>
                  <div className="myLink">
                    <i className="count"> {Utils.random(1, 81)} </i>
                    <Link>Links</Link>
                  </div>
                </div>
              </div>
            ...
            <div style={{ marginLeft: "auto" }}>
              {/* onClick={OpenFile} */}
              <Link to="/dashboard/Admin" className=" my-font text-dark">
            ...
            <div className="col-xl-7 mr-5 margRemove bg-white py-4 px-5 shadow  ">
              ...
              <div className="mt-4">
                ...
                <div className="d-flex ml-4">
                  ...
                  <Link className="taskBadge">Approved</Link>
                </div>
                <div className="d-flex ml-4">
                  <div className="mt-3">
                    <input
